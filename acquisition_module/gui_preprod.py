...
from acquisition import Connection, Ui_OtherWindow, Ui_Table_Window
...
class Ui_MainWindow(object):
    ...
    def start_acquisition(self):
        ...
        if reply == QMessageBox.Yes:
            ...
            self.ui_canvas = Ui_OtherWindow(self.otherwindow, self.config, conn, self.push_button_style_sheet,self.ui_table)
